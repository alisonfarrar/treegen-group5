            ...
            <v-row>
                <v-col cols="12" sm="2">
                    <v-dialog v-model="dialog" width="500">
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <p></p>
                                <p>
                                    Lindenmayer systems (L-systems) are systems
                                    that enable the definition of complex shapes
                                    through the use of iteration and formal
                                    grammar.
                                </p>
                                <p>
                                    They’re named after their creator, Hungarian
                                    theoretical biologist Aristid Lindenmayer,
                                    who initially conceived them as a
                                    mathematical theory of plant development.
                                    L-systems are based on the concept of
                                    ‘rewriting’ - the process of defining
                                    complex objects by successively replacing
                                    parts of a simple initial object (or
                                    ‘axiom’) using a specific set of rules,
                                ...
                                <p>
                                    ...
                                    our
                                    <a
                                        href="https://github.com/alisonfarrar/treegen-group5"
                                        class="github-link"
                                    >
                                        GitHub repository!
                                    </a>
                    ...
                    <v-tooltip bottom>
                        ...
                        <span>
                            Pick a tree: Which default tree do you want to start
                            with?<br />
                            Iterations: How many times will productions be
                            applied?<br />
                            Rotation: At what angle should the branches
                            diverge?<br />
    ...
    methods: {
        ...
        submit() {
            ...
            for (prod = 0; prod < this.settings.prod_keys.length; prod++) {
                tree.setProduction(
                    this.settings.prod_keys[prod],
                    this.settings.prod_values[prod]
                )
            }
